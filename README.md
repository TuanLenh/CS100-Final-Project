...
The "Leaderboard" class handles the functionality for the leaderboard in the single player mode of the game, such as adding new players to the leaderboard, updating the scores of existing players, and sorting the leaderboard. The "Player" struct is extremely important for the functionality of this class, as it allows for the player's name, as well as the player's score, to be managed efficiently through the use of vectors.
