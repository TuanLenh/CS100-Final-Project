...
using namespace std;
    ...
    void Inventory::useInventory(Character &char1, Character &char2){
        if(char1.getName() == "Mario"){
            // increase user attack stat
            int newAttack = char1.getAttack() + char1.getAttack() * 0.2;
            char1.setAttack(newAttack);
        }
        else if(char1.getName() == "Bowser Jr"){
            // decrease user attack stat
            int newDefense = char1.getDefense() + char1.getDefense() * 0.2;
            ...
            int newAttack = char1.getAttack() + char1.getAttack() * 0.12;
            char1.setAttack(newAttack);
            int newDefense = char1.getDefense() + char1.getDefense() * 0.12;
            char1.setDefense(newDefense);
        }
